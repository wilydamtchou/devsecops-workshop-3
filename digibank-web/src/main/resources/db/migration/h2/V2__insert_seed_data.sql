MERGE INTO customers (id, full_name, email, phone_number, national_id, created_at)
KEY (id)
VALUES
...
MERGE INTO accounts (id, account_number, balance, account_type, customer_id, created_at)
KEY (id)
VALUES
...
MERGE INTO transfers (id, source_account_id, destination_account_id, amount, description, created_at)
KEY (id)
VALUES
...
ALTER TABLE transfers ALTER COLUMN id RESTART WITH 3;
